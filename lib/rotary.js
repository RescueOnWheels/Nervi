...
class Rotary extends EventEmitter {
  ...
  constructor(pin) {
     ...
     */
    this.interval = setInterval(this.calculateSpeed.bind(this), 500);
  }
  ...
  /**
   * Returns the distance covered so far, resets the counter to zero.
   */
  get distance() {
    /**
     * The total distance covered in meters.
     */
    const distance = WHEEL_CIRCUMFERENCE * (this.distanceCount / WHEEL_SPOKES);
